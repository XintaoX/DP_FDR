...
one_iteration<-function(m = 1e5,
  ...
  for (i in 1:m1) {
    #add noisy
    qptilde <- qp + rlaplace(n = m, location = 0, scale = lambda)
...
for (vi in 1:length(v_epsilon)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_epsilon.fdr",v_epsilon[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_epsilon.power",v_epsilon[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_eta)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_eta.fdr",v_eta[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_eta.power",v_eta[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_beta)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_beta.fdr",v_beta[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_beta.power",v_beta[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_tr)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_tr.fdr",v_tr[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_tr.power",v_tr[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_epsilon)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_epsilon.fdr.con",v_epsilon[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_epsilon.power.con",v_epsilon[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_eta)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_eta.fdr.con",v_eta[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_eta.power.con",v_eta[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_beta)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_beta.fdr.con",v_beta[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_beta.power.con",v_beta[vi],".csv",sep = ""))
}
stopCluster(cl)
...
for (vi in 1:length(v_tr)){
  ...
  result2 <- cbind(sapply(result[1,], function(x) x[1]),sapply(result[2,], function(x) x[1]),sapply(result[3,], function(x) x[1]),sapply(result[4,], function(x) x[1]))
  result3 <- cbind(sapply(result[1,], function(x) x[2]),sapply(result[2,], function(x) x[2]),sapply(result[3,], function(x) x[2]),sapply(result[4,], function(x) x[2]))
  write.csv(result2,paste("./result/v_tr.fdr.con",v_tr[vi],".csv",sep = ""))
  write.csv(result3,paste("./result/v_tr.power.con",v_tr[vi],".csv",sep = ""))
}
stopCluster(cl)
