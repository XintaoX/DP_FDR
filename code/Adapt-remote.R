...
set.seed(951004)
l1m5.5result <-  foreach(mc = 1:100, .combine = cbind,.packages = c("VGAM")) %dopar% one_iteration_example1(mu00 = 4.5)
...
write.csv(result1,"/work/LAS/zhuz-lab/xintaox/result/let_seting_example1_fdr.csv")
write.csv(result2,"/work/LAS/zhuz-lab/xintaox/result/let_seting_example1_power.csv")
...
set.seed(951004)
l1m4.5result <-  foreach(mc = 1:100, .combine = cbind,.packages = c("VGAM")) %dopar% one_iteration_example1(location = 2,mu00 = 3.5)
result1<-cbind(result1,Reduce("+",l1m4.5result[1,])/100,Reduce("+",l1m4.5result[3,])/100,Reduce("+",l1m4.5result[5,])/100)
result2<-cbind(result2,Reduce("+",l1m4.5result[2,])/100,Reduce("+",l1m4.5result[4,])/100,Reduce("+",l1m4.5result[6,])/100)
result3<-cbind(result3,Reduce("+",l1m4.5result[7,])/100,Reduce("+",l1m4.5result[8,])/100)
...
set.seed(951004)
l1m5.5result <-  foreach(mc = 1:100, .combine = cbind,.packages = c("VGAM")) %dopar% one_iteration_example1(location = 2,mu00 = 4.5)
result1<-cbind(result1,Reduce("+",l1m5.5result[1,])/100,Reduce("+",l1m5.5result[3,])/100,Reduce("+",l1m5.5result[5,])/100)
result2<-cbind(result2,Reduce("+",l1m5.5result[2,])/100,Reduce("+",l1m5.5result[4,])/100,Reduce("+",l1m5.5result[6,])/100)
result3<-cbind(result3,Reduce("+",l1m5.5result[7,])/100,Reduce("+",l1m5.5result[8,])/100)

write.csv(result1,"/work/LAS/zhuz-lab/xintaox/result/let_seting_example2_fdr.csv")
write.csv(result2,"/work/LAS/zhuz-lab/xintaox/result/let_seting_example2_power.csv")

result1<-NULL
result2<-NULL
###alpha case mu00=2.5,location=3
set.seed(951004)
l1m3.5result <-  foreach(mc = 1:100, .combine = cbind,.packages = c("VGAM")) %dopar% one_iteration_example1(location = 3,mu00 = 2.5)
result1<-cbind(result1,Reduce("+",l1m3.5result[1,])/100,Reduce("+",l1m3.5result[3,])/100,Reduce("+",l1m3.5result[5,])/100)
result2<-cbind(result2,Reduce("+",l1m3.5result[2,])/100,Reduce("+",l1m3.5result[4,])/100,Reduce("+",l1m3.5result[6,])/100)
result3<-cbind(result3,Reduce("+",l1m3.5result[7,])/100,Reduce("+",l1m3.5result[8,])/100)
...
set.seed(951004)
l1m4.5result <-  foreach(mc = 1:100, .combine = cbind,.packages = c("VGAM")) %dopar% one_iteration_example1(location = 3,mu00 = 3.5)
result1<-cbind(result1,Reduce("+",l1m4.5result[1,])/100,Reduce("+",l1m4.5result[3,])/100,Reduce("+",l1m4.5result[5,])/100)
result2<-cbind(result2,Reduce("+",l1m4.5result[2,])/100,Reduce("+",l1m4.5result[4,])/100,Reduce("+",l1m4.5result[6,])/100)
result3<-cbind(result3,Reduce("+",l1m4.5result[7,])/100,Reduce("+",l1m4.5result[8,])/100)
...
set.seed(951004)
l1m5.5result <-  foreach(mc = 1:100, .combine = cbind,.packages = c("VGAM")) %dopar% one_iteration_example1(location = 3,mu00 = 4.5)
result1<-cbind(result1,Reduce("+",l1m5.5result[1,])/100,Reduce("+",l1m5.5result[3,])/100,Reduce("+",l1m5.5result[5,])/100)
result2<-cbind(result2,Reduce("+",l1m5.5result[2,])/100,Reduce("+",l1m5.5result[4,])/100,Reduce("+",l1m5.5result[6,])/100)
result3<-cbind(result3,Reduce("+",l1m5.5result[7,])/100,Reduce("+",l1m5.5result[8,])/100)

write.csv(result1,"/work/LAS/zhuz-lab/xintaox/result/let_seting_example3_fdr.csv")
write.csv(result2,"/work/LAS/zhuz-lab/xintaox/result/let_seting_example3_power.csv")
write.csv(result3,"/work/LAS/zhuz-lab/xintaox/result/computation_time.csv")
